   ...
   <ul class="sidebar-menu do-nicescrol">
      <li>
        <a href="dashboard.php">
          <i class="zmdi zmdi-home <?php echo $active_page == 'Dashboard' ? 'active' : ''  ?>"></i> <span>Home</span>
        </a>
      </li>

      <li>
        <a href="user.php">
          <i class="zmdi zmdi-folder-person <?php echo $active_page == 'User' ? 'active' : ''  ?>"></i> <span>User</span>
        </a>
      </li>

      <li>
        <a href="gad_survey.php">
          <i class="zmdi zmdi-library <?php echo $active_page == 'GAD-7 Survey' ? 'active' : ''  ?>"></i> <span>GAD Survey</span>
        </a>
      </li>

      <li>
        <a href="gad.php">
          <i class="zmdi zmdi-library <?php echo $active_page == 'Gad' ? 'active' : ''  ?>"></i> <span>GAD - 7 Questionnaire</span>
        </a>
      </li>

      <li>
        <a href="dass_survey.php">
          <i class="zmdi zmdi-library <?php echo $active_page == 'DASS-SURVEY' ? 'active' : ''  ?>"></i> <span>Dass Survey</span>
        </a>
      </li>

      <li>
        <a href="dass.php">
          <i class="zmdi zmdi-library <?php echo $active_page == 'dass' ? 'active' : ''  ?>"></i> <span>Dass - 21 Questionnaire</span>
        </a>
      </li>

      <li>
        <a href="kessler_survey.php">
          <i class="zmdi zmdi-library <?php echo $active_page == 'KESSLER-SURVEY' ? 'active' : ''  ?>"></i> <span>Kessler Survey</span>
        </a>
      </li>

      <li>
        <a href="kessler.php">
          <i class="zmdi zmdi-library <?php echo $active_page == 'Kessler' ? 'active' : ''  ?>"></i> <span>Kessler Questionnaire</span>
        </a>
      </li>
    </ul>
    ...
    <li class="nav-item">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        ...
        <li class="dropdown-item" data-toggle="modal" data-target="#exampleModalCenter" style="cursor: pointer;">
            <!-- <i class="icon-envelope mr-2"></i> Profile -->
            <a  aria-expanded="true"><i class="icon-envelope mr-2"></i><span>Profile</span></a>
        </li>
        <li class="dropdown-divider"></li>
