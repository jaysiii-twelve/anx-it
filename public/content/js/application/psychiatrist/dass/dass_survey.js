Vue.component('dass-management-datatable', {
	...
	methods : {
		...
		redirectToDetails : function(dassId) {
			...
			window.location = "https://anx-it.herokuapp.com/public/views/psychiatrist/dass_survey_details.php";
		},
		redirectToSurveyReport : function(dassId) {
			...
			window.open("https://anx-it.herokuapp.com/public/views/psychiatrist/dass_survey_recommendation.php");
		}
	},
	updated() {
