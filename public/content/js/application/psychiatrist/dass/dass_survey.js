Vue.component('dass-management-datatable', {
	...
	methods : {
		...
		redirectToDetails : function(dassId) {
			...
			window.location = "http://localhost:8080/AAA/public/views/psychiatrist/dass_survey_details.php";
		},
		redirectToSurveyReport : function(dassId) {
			...
			window.open("http://localhost:8080/AAA/public/views/psychiatrist/dass_survey_recommendation.php");
		}
	},
	updated() {
