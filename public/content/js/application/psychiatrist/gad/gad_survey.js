Vue.component('gad-management-datatable', {
	...
	methods : {
		...
		redirectToDetails : function(gadId) {
			...
			window.location = "http://localhost:8080/AAA/public/views/psychiatrist/gad_survey_details.php";
		},
		...
		redirectToSurveyReport : function(gadId) {
			...
			window.open("http://localhost:8080/AAA/public/views/psychiatrist/gad_survey_recommendation.php");
		}
	},
	updated() {
