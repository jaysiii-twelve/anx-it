Vue.component('k-management-datatable', {
	...
	methods : {
		...
		redirectToDetails : function(kesslerId) {
			...
			window.location = "http://localhost:8080/AAA/public/views/admin/kessler_survey_details.php";
		},
		redirectToSurveyReport : function(kesslerId) {
			...
			window.open("http://localhost:8080/AAA/public/views/admin/kessler_survey_recommendation.php");
		}
	},
	updated() {
