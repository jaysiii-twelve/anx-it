	    ...
	    <div class="card mt-3">
            <div class="card-content">
                <div class="row row-group m-0">
                    ...
                    <div class="col-12 col-lg-6 col-xl-3 border-light">
                        <div class="card-body">
                            <h5 class="text-white mb-0">User <span class="float-right"><i class="fa fa-user"></i></span></h5>
                                <hr>
                            <p class="mb-0 text-white small-font">Total Survey <span class="float-right">{{users.length}}</span></p>
                            </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-group m-0">
                    <div class="col-12 col-lg-6 col-xl-12 border-light">
                        <div class="card-body">
                            ...
                            <button @click="redirectToGadSurvey" class="btn btn-light btn-block mt-3">See More</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-group m-0">
                    <div class="col-12 col-lg-6 col-xl-12 border-light">
                        <div class="card-body">
                            ...
                            <button @click="redirectToDassSurvey" class="btn btn-light btn-block mt-3">See More</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-group m-0">
                    <div class="col-12 col-lg-6 col-xl-12 border-light">
                        <div class="card-body">
                            ...
                            <button @click="redirectToKesslerSurvey" class="btn btn-light btn-block mt-3">See More</button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php include(SHARED_PATH . '/admin/dashboard/dashboard_footer.php') ?>