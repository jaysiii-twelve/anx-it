...
<head>
    ...
    <title>AAA - Kessler 10 Recommendation</title>
</head>
...
<div id="vue-kessler-survey-recommendation" v-cloak>
	   			...
	   			<div class="card-body">
					<div class="card-content p-2">
                        ...
                        <div class="form-row mt-5">
                            ...
                            <div class="form-group col-12">
                                <label  style="color: #000000; text-transform: none;" for="name">Survey Taken: <u>KESSLER-10</u></label>
                            </div>

                            <div class="form-group col-12">
                                <label  style="color: #000000; text-transform: none;" for="name">Survey Description: </label>
                            </div>

                            <div class="form-group col-12">
                                <label  style="color: #000000; text-transform: none;" for="name">
                                    KESSLER-10 Total Score Symptom Range. <br><br>
                                    10-19 Likely to be well <br>
                                    20-24 Likely to have a mild disorder <br>
                                    25-29 Likely to have a moderate disorder <br>
                                    30-50 Likely to have a severe disorder <br>
                                </label>
                            </div>
                        </div>
                        ...
                        <div v-for="(kesslerDetail, index) in kesslerDetails">
                            ...
                            <div class="form-row ml-3">
                                ...
                                <div class="form-group col-3">
                                    ...
                                    <label for="kesslerDetail.kesslerName" style="color: black">{{kesslerDetail.KesslerChoicesOne + " - " + kesslerDetail.KesslerChoicesOneDescription}}</label>
                                </div>
                                <div class="form-group col-3">
                                    ...
                                    <label for="kesslerDetail.kesslerName" style="color: black">{{kesslerDetail.KesslerChoicesTwo + " - " + kesslerDetail.KesslerChoicesTwoDescription}}</label>
                                </div>
                                <div class="form-group col-3">
                                    ...
                                    <label for="kesslerDetail.kesslerName" style="color: black">{{kesslerDetail.KesslerChoicesThree + " - " + kesslerDetail.KesslerChoicesThreeDescription}}</label>
                                </div>
                                <div class="form-group col-3">
                                    ...
                                    <label for="kesslerDetail.kesslerName" style="color: black">{{kesslerDetail.KesslerChoicesFour + " - " + kesslerDetail.KesslerChoicesFourDescription}}</label>
                                </div>
                                <div class="form-group col-3">
                                    ...
                                    <label for="kesslerDetail.kesslerName" style="color: black">{{kesslerDetail.KesslerChoicesFive + " - " + kesslerDetail.KesslerChoicesFiveDescription}}</label>
                                </div>
                            </div>
                            <hr>
                        </div>
 ...
 <!-- simplebar js -->
  ...
  <!-- dashboard -->
  <script src="../../content/js/application/psychiatrist/kessler/kessler_survey_recommendation.js"></script>
</div>
